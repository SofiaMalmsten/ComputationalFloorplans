...
namespace PlotPlanning.Engine.Base
{
    ...
    {
        public static (Brep, Point3d, Rectangle3d) ReadHouseGeometry(string houseType)
        {
            ...
            Point point = GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(brep_string)) as Point;
            Point3d point3d = point.Location; 
            PolylineCurve rec_plc = GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(brep_string)) as PolylineCurve;
