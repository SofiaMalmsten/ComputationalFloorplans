...
{
    public class PointsOnCurve : GH_Component
    {
        ...
        /// </summary>
        public PointsOnCurve()
          : base("PointsOnCuvre", "PointsOnCurve",
              "PointsOnCurve",
        ...
        {
            get { return new Guid("a48343e7-9fcb-4b53-a5ce-c1ba66b60d33"); }
        }
        ...
        {
            pManager.AddGenericParameter("SFH", "SFH", "SFH", GH_ParamAccess.item);
