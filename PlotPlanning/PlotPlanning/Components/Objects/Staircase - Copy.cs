...
{
    public class Staircase2 : GH_Component
    {
        ...
        {
            get { return new Guid("a2e2130f-9057-42f3-83c3-6a4590727a06"); }
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddVectorParameter("dir", "D", "Flip direction", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            ObjectModel.Staircase staircase = new ObjectModel.Staircase(pl, widthStair, heightStair, widhthLanding, heightLanding, dir);
